...
<template>
    <v-card class="justify-center" >
      ...
      <v-card-text class="body-1 text-body-1 py-3" v-html="getTextFileContent()">
      </v-card-text>
...
module.exports = {
    ...
    computed: {
      ...
      getTextFileContent: function() {
          var textFile=this.request.TextFileName
          console.log("TODO: Fetch the text file from backend and display." + textFile)
