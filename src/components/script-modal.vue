...
import ScriptLogs from './script-logs.vue';
import MessageBoxVue from './widget-message-box.vue';
import InfoBoxVue from './widget-info-box.vue';
import YesNoBoxVue from './widget-yesno-box.vue';
import InputBoxVue from './widget-input-box.vue';
import MenuBoxVue from './widget-menu-box.vue';
import ChecklistBoxVue from './widget-checklist-box.vue';
import RadiolistBoxVue from './widget-radiolist-box.vue';
import PasswordBoxVue from './widget-password-box.vue';
import TextFileBoxVue from './widget-textfile-box.vue';
import ProgressBoxVue from './widget-progress-box.vue';
...
export default {
    ...
    computed: {
       ...
       actionbtn: function() {
            ...
            arr.forEach(function(a) {
                 var obj=self.$store.state.script_actions[a]
    ...
    watch: {
      uimodal_active: function(newVal, ) {
    ...
    methods: {
      ...
      doneResponseFromUI: function(response, nextFn) {
         ...
         var self=this
         this.interact(command, content, null, function() {
   ...
   mounted: function() {
       var self=this
       this.$EventBus.$on('timer1sec', function() {
